...
<center> <a href="forget1.php"> Forget Password?</a></center><br>
 <center> <a href="register.php"> Click Here </a> If you have not yet Register </center>
</center>
</section>
<br><br><br><br><br><br>
<br><br>
		...
		if(empty($email) || empty($pwd))
		...
		else
			{
				 $sql1 = "SELECT * FROM user_register where email='$email'";
					...
					if($status=="none")
					{
							echo "<script> alert('Your account has been ban, contact administrator');</script>";
					}
					else
					{
					echo mysqli_error($con);
						$en_pwd=md5($pwd);
						$sql = "SELECT * FROM user_register WHERE email = '$email' and password = '$en_pwd'";
